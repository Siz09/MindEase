...
const moodScale = [
  { value: 1, emoji: '😭', labelKey: 'mood.terrible', fallback: 'Terrible' },
  { value: 2, emoji: '😢', labelKey: 'mood.veryBad', fallback: 'Very Bad' },
  { value: 3, emoji: '😔', labelKey: 'mood.bad', fallback: 'Bad' },
  { value: 4, emoji: '😕', labelKey: 'mood.poor', fallback: 'Poor' },
  { value: 5, emoji: '😐', labelKey: 'mood.neutral', fallback: 'Neutral' },
  { value: 6, emoji: '🙂', labelKey: 'mood.okay', fallback: 'Okay' },
  { value: 7, emoji: '😊', labelKey: 'mood.good', fallback: 'Good' },
  { value: 8, emoji: '😄', labelKey: 'mood.veryGood', fallback: 'Very Good' },
  { value: 9, emoji: '😁', labelKey: 'mood.great', fallback: 'Great' },
  { value: 10, emoji: '🤩', labelKey: 'mood.amazing', fallback: 'Amazing' },
];
