...
const Navbar = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          <path
            d="M3 3v18h18M7 12v5M12 8v9M17 5v12"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            fill="none"
  ...
  // Desktop navigation items (shown between logo and profile)
  const desktopNavItems = [
    { path: '/chat', label: t('navigation.chat') || 'Chat' },
    { path: '/', label: t('navigation.mood') || 'Check-in' },
    { path: '/insights', label: t('navigation.insights') || 'Insights' },
  ];
    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <div className="navbar-brand">
          <img src="/mindease-logo.png" alt="MindEase Logo" width="48" height="48" />
        ...
        {/* Right: Theme Toggle, Profile Dropdown (Desktop) or Burger Menu (Mobile) */}
