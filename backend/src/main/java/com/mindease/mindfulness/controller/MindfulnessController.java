package com.mindease.mindfulness.controller;
...
import com.mindease.mindfulness.repository.UserMindfulnessPreferencesRepository;
import com.mindease.mindfulness.service.MindfulnessRecommendationService;
...
public class MindfulnessController {
    ...
    public ResponseEntity<?> recordCompletion(
        ...
        try {
            ...
            MindfulnessSessionActivity activity = mindfulnessService.recordCompletion(
    ...
    public ResponseEntity<?> getAnalytics(
        ...
        try {
            ...
            Long totalMinutes = mindfulnessService.getTotalMinutes(user, since);
            Map<String, Object> streak = mindfulnessService.getUserStreak(user);
            List<MindfulnessSessionActivity> recentActivities = mindfulnessService.getSessionHistory(user, 10);

            // Get actual total session count in the time window
            Long actualTotalSessions = mindfulnessService.countSessionsBetween(user, since, LocalDateTime.now());
    ...
    public ResponseEntity<?> getHistory(
        ...
        try {
            ...
            List<MindfulnessSessionActivity> history = mindfulnessService.getSessionHistory(user, limit);
