package com.mindease.crisis.repository;
...
public interface CrisisFlagRepository extends JpaRepository<CrisisFlag, UUID> {
    ...
    @Query("SELECT new com.mindease.admin.dto.CrisisStatsResponse(" +
    ...
    @Query("SELECT new com.mindease.admin.dto.KeywordStat(LOWER(f.keywordDetected), COUNT(f)) " +
            "FROM CrisisFlag f " +
