 ...
 * Used by the safety classification system to determine appropriate response and escalation.
 */
public enum RiskLevel {
    ...
    /**
     * Medium risk - moderate distress, mentions of self-harm thoughts without intent
     */
    MEDIUM,
