...
import com.mindease.chat.model.enums.SelectionStrategy;
...
public class AIProviderConfig {
    ...
    private SelectionStrategy selectionStrategy = SelectionStrategy.USER_PREFERENCE;
    @Valid
    ...
    public void setSelectionStrategy(String selectionStrategy) {
        this.selectionStrategy = SelectionStrategy.fromString(selectionStrategy);
    }
