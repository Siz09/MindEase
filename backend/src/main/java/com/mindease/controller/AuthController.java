...
public class AuthController {
  ...
  public ResponseEntity<?> register(@RequestBody RegisterRequest request) {
    try {
      ...
      return ResponseEntity.ok(createAuthResponse(user, jwtToken, refreshToken.getToken(), "Registration successful"));
  ...
  public ResponseEntity<?> refreshToken(@RequestBody RefreshTokenRequest request) {
    try {
      ...
      return ResponseEntity.ok(createAuthResponse(user, newJwtToken, newRefreshToken.getToken(), "Token refreshed successfully"));
  ...
  public ResponseEntity<?> sendVerificationEmail(Authentication authentication) {
    try {
      ...
      if (user.isEmailVerified()) {
        return ResponseEntity.badRequest().body(ErrorResponse.of("Email is already verified", "EMAIL_ALREADY_VERIFIED"));
      }
  ...
  public ResponseEntity<?> verifyEmail(@RequestParam String token) {
    try {
      ...
      if (verified) {
        ...
        return ResponseEntity.badRequest().body(ErrorResponse.of("Invalid or expired verification token", "INVALID_VERIFICATION_TOKEN"));
      }
