...
public class AuditService {
    ...
    public void login(UUID userId) { logAction(userId, ACTION_LOGIN, "User logged in"); }
    public void chatSent(UUID userId) { logAction(userId, ACTION_CHAT_SENT, "Chat message sent"); }
    public void moodAdded(UUID userId) { logAction(userId, ACTION_MOOD_ADDED, "Mood entry added"); }
    public void journalAdded(UUID userId) { logAction(userId, ACTION_JOURNAL_ADDED, "Journal entry added"); }
}
